...
interface Ranobe {
     ...
     */
    index(params: Ranobe.Index.Params) : Promise< Shikimori.Ranobe[] >;
     ...
     */
    topics(id: number, params: Ranobe.Topics.Params) : Promise< Shikimori.Topic<'Ranobe'>[] >;
}