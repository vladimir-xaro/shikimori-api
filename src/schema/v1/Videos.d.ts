declare namespace Schema.v1 {
    namespace Videos {
        namespace Create {
            ...
            type Params = {
                video:  Schema.v1.Videos.Create.Params.Video;
            };
        }
    }
    interface Videos {
         ...
         * @scope `content`
         */
        create(anime_id: number, params: Schema.v1.Videos.Create.Params) : Promise< Shikimori.Video >;
