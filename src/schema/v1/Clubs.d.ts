import type { BoolOrNumBool, ParamsWithPage } from '@@types/general.d.ts';
...
export interface Clubs {
     ...
     */
    index(params: Clubs.Index.Params) : Promise< Shikimori.Club[] >;
     ...
     * @scope clubs
     */
    update(id: number, params?: Clubs.Update.Params) : Promise< Shikimori.Club[] >;
