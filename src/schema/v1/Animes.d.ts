...
export interface Animes {
     ...
     */
    index(params: Animes.Index.Params) : Promise< Shikimori.Anime[] >;
     ...
     * @description
     */
    topics(id: number, params: Animes.Topics.Params) : Promise< Shikimori.Topic<'Anime'>[] >;
}