declare namespace Schema.v1 {
    ...
    interface Users {
         ...
         * @route GET /api/users
         */
        index(params?: Schema.v1.Users.Index.Params) : Promise< Shikimori.User[] >;
         ...
         */
        get(id: number | string, params?: Schema.v1.Users.Get.Params) : Promise< Shikimori.User.Extended >;
         ...
         */
        sign_out() : Promise< Schema.v1.Users.SignOut.Response >;

        /**
         * @see Schema.v1.Users.sign_out
         * @alias sign_out
         */
        signOut() : Promise< Schema.v1.Users.SignOut.Response >;
        ...
        */
         ...
         * @alias anime_rates
         */
        animeRates(id: number | string, params?: Schema.v1.Users.AnimeRates.Params) : Promise< Shikimori.UserRate.WithUserAndTitle<'anime'>[] >;
         ...
         * @alias manga_rates
         */
        mangaRates(id: number | string, params?: Schema.v1.Users.MangaRates.Params) : Promise< Shikimori.UserRate.WithUserAndTitle<'manga'>[] >;
         ...
         * @scope `messages`
         */
        messages(params: Schema.v1.Users.Messages.Params<'inbox'>) : Promise< Shikimori.Message.Extended<null> >;
        messages(params: Schema.v1.Users.Messages.Params<'sent'>) : Promise< Shikimori.Message.Extended<null> >;
        messages(params: Schema.v1.Users.Messages.Params<'private'>) : Promise< Shikimori.Message.Extended<null> >;
        messages(params: Schema.v1.Users.Messages.Params<'news'>) : Promise< Shikimori.Message.Extended<Shikimori.Message.Linked.Type> >;
        messages(params: Schema.v1.Users.Messages.Params<'notifications'>) : Promise< Shikimori.Message.Extended<Shikimori.Message.Linked.Type> >;
        ...
        */
         ...
         */
        history(id: number | string, params?: Schema.v1.Users.History.Params) : Promise< Shikimori.User.History[] >;
